...
from loja.models import Produto, LoteProduto, ItemPedido, Pedido, Cliente
from loja.utils import baixar_estoque, devolver_estoque
...
class EstoqueFIFOTestCase(TestCase):
    ...
    def test_baixar_estoque_fifo_real(self):
        ...
        print("ANTES FIFO:", lote_antigo.quantidade)
